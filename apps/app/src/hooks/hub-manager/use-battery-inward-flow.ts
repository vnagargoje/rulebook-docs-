...
export type InwardStep = 'select-movement' | 'scan' | 'confirm' | 'submitting' | 'success' | 'error'
...
export const useBatteryInwardFlow = () => {
    const [step, setStep] = useState<InwardStep>('select-movement')

...
export class completeMay_11_20261778502053570 implements MigrationInterface {
    name = 'completeMay_11_20261778502053570'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`stations\` (\`id\` varchar(26) NOT NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deletedAt\` datetime(6) NULL, \`type\` enum ('swap_station', 'hub_station') NOT NULL, \`name\` varchar(255) NOT NULL, \`latitude\` decimal(10,8) NULL, \`longitude\` decimal(11,8) NULL, \`active\` tinyint NOT NULL DEFAULT 1, \`addressId\` varchar(255) NULL, UNIQUE INDEX \`REL_d077f78e3da856a69763bb467c\` (\`addressId\`), INDEX \`IDX_ee84d76806d2dbd975c7708efc\` (\`type\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        ...
        await queryRunner.query(`CREATE TABLE \`top_ups\` (\`id\` varchar(26) NOT NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deletedAt\` datetime(6) NULL, \`name\` varchar(150) NOT NULL, \`description\` text NULL, \`validityDays\` int NOT NULL, \`kmLimit\` decimal(10,2) NOT NULL, \`price\` decimal(10,2) NOT NULL, \`gstPercentage\` decimal(10,2) NOT NULL DEFAULT '0.00', \`active\` tinyint NOT NULL DEFAULT 1, UNIQUE INDEX \`IDX_941d8639a884218b46ae74c8a8\` (\`name\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);

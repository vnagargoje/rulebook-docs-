                ...
                return (
                    <div className='flex items-center gap-2'>
                        ...
                        <div>
                            ...
                            <p className='text-xs text-muted-foreground'>{user?.mobilenumber ?? 'N/A'}</p>
                        </div>
                    </div>
                )
            },
        },
        {
            ...
            cell: (item) => (
                <span className='rounded-md bg-red-50 px-2 py-0.5 text-xs font-mono font-medium text-red-700'>
                    {item.oldBattery?.batteryQrId ?? 'N/A'}
                </span>
            ),
        },
        {
            ...
            cell: (item) => (
                <span className='rounded-md bg-emerald-50 px-2 py-0.5 text-xs font-mono font-medium text-emerald-700'>
                    {item.newBattery?.batteryQrId ?? 'N/A'}
                </span>
            ),
        },
        {
            ...
            cell: (item) => (
                <div>
                    <p className='text-sm font-medium'>{item.fromStation?.name ?? item.toStation?.name ?? 'N/A'}</p>

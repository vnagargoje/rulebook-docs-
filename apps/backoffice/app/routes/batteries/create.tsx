...
export default function CreateBatteryRoute() {
    ...
    const onSubmit = useCallback((values: CreateBatteryFormValues) => {
                    ...
                    <Form {...form}>
                        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
                            ...
                            <div className="flex justify-end gap-3 pt-6 border-t mt-4">
                                ...
                                <Button type="submit" disabled={createBattery.isPending} className="min-w-35 uppercase text-xs font-bold tracking-widest">

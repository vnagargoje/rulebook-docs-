                ...
                <ScrollView
                    ...
                    <View className='gap-5'>
                        ...
                        <View className='rounded-3xl border border-neutral-200 bg-white p-5'>
                            ...
                            <View className='mt-4 flex-row'>
                                <View className='flex-1 items-center border-r border-neutral-100 py-3'>
                                    <Text className='text-[10px] font-semibold uppercase tracking-[1px] text-neutral-400'>Validity</Text>
                                    <Text className='mt-1 text-base font-bold text-neutral-900'>
                                        {plan.validityDays} days
                                    </Text>
                                </View>
                                <View className='flex-1 items-center border-r border-neutral-100 py-3'>
                                    <Text className='text-[10px] font-semibold uppercase tracking-[1px] text-neutral-400'>KM Limit</Text>
                                    <Text className='mt-1 text-base font-bold text-neutral-900'>
                                        {formatNumberIN(plan.kmLimit)}
                                    </Text>
                                </View>
                                <View className='flex-1 items-center py-3'>
                                    <Text className='text-[10px] font-semibold uppercase tracking-[1px] text-neutral-400'>Swaps</Text>
                        ...
                        <View className='rounded-3xl border border-neutral-200 bg-white p-5'>
                            ...
                            <View className='mt-2'>
                                <SummaryRow label='Base price' value={formatCurrencyIN(plan.price)} />
                                <View className='border-b border-neutral-100' />
                                <SummaryRow label='Security deposit (refundable)' value={formatCurrencyIN(plan.deposit)} />
                                <View className='border-b border-neutral-100' />
                                <SummaryRow label='GST' value={formatCurrencyIN(plan.gst)} />
                                <View className='border-b border-neutral-100' />
                                <SummaryRow label='Registration fee' value={formatCurrencyIN(plan.registrationFee)} />

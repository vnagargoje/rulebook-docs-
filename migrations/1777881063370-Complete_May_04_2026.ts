...
export class completeMay_04_20261777881063370 implements MigrationInterface {
    name = 'completeMay_04_20261777881063370'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`top_ups\` (\`id\` varchar(26) NOT NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deletedAt\` datetime(6) NULL, \`name\` varchar(150) NOT NULL, \`description\` text NULL, \`validityDays\` int NOT NULL, \`kmLimit\` decimal(10,2) NOT NULL, \`price\` decimal(10,2) NOT NULL, \`gst\` decimal(10,2) NOT NULL DEFAULT '0.00', \`active\` tinyint NOT NULL DEFAULT 1, UNIQUE INDEX \`IDX_941d8639a884218b46ae74c8a8\` (\`name\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);

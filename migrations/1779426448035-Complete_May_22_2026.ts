...
export class completeMay_22_20261779426448035 implements MigrationInterface {
    name = 'completeMay_22_20261779426448035'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`batteries\` (\`id\` varchar(26) NOT NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deletedAt\` datetime(6) NULL, \`batteryQrId\` varchar(255) NOT NULL, \`gpsId\` varchar(255) NULL, \`properties\` json NULL, \`status\` enum ('available', 'charged', 'charging', 'drained', 'in_transit', 'in_use') NOT NULL DEFAULT 'available', \`range\` int NULL, \`qrCodeId\` varchar(255) NULL, \`stationId\` varchar(255) NULL, UNIQUE INDEX \`IDX_9afc283ccef094119e9e8ebacd\` (\`batteryQrId\`), UNIQUE INDEX \`REL_f575b49083c8ddf1c92f79fc30\` (\`qrCodeId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`vehicles\` (\`id\` varchar(26) NOT NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deletedAt\` datetime(6) NULL, \`type\` enum ('rental', 'transport') NOT NULL DEFAULT 'rental', \`vehicleNumber\` varchar(255) NULL, \`status\` enum ('in_use', 'available', 'unavailable') NOT NULL DEFAULT 'available', \`rcNumber\` varchar(255) NULL, \`chassisNumber\` varchar(255) NULL, \`gpsId\` varchar(255) NULL, \`properties\` json NULL, \`stationId\` varchar(255) NULL, UNIQUE INDEX \`IDX_6165f51ba0c8c31b6ab41838e3\` (\`vehicleNumber\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`stations\` (\`id\` varchar(26) NOT NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deletedAt\` datetime(6) NULL, \`type\` enum ('swap_station', 'hub_station', 'vehicle_station') NOT NULL, \`name\` varchar(255) NOT NULL, \`latitude\` decimal(10,8) NULL, \`longitude\` decimal(11,8) NULL, \`active\` tinyint NOT NULL DEFAULT 1, \`addressId\` varchar(255) NULL, UNIQUE INDEX \`REL_d077f78e3da856a69763bb467c\` (\`addressId\`), INDEX \`IDX_ee84d76806d2dbd975c7708efc\` (\`type\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`users\` (\`id\` varchar(26) NOT NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deletedAt\` datetime(6) NULL, \`email\` varchar(255) NULL, \`mobilenumber\` varchar(255) NULL, \`password\` varchar(255) NULL, \`firstName\` varchar(255) NULL, \`lastName\` varchar(255) NULL, \`avatar\` varchar(255) NULL, \`dateOfBirth\` date NULL, \`gender\` enum ('male', 'female', 'other') NULL, \`properties\` json NULL, \`stationId\` varchar(255) NULL, INDEX \`IDX_c65791a450647d236039188a07\` (\`email\`, \`mobilenumber\`), UNIQUE INDEX \`IDX_97672ac88f789774dd47f7c8be\` (\`email\`), UNIQUE INDEX \`IDX_41823e592cca849bbb4c7e72a7\` (\`mobilenumber\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`addresses\` (\`id\` varchar(26) NOT NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deletedAt\` datetime(6) NULL, \`lineOne\` varchar(255) NOT NULL, \`lineTwo\` varchar(255) NULL, \`pincode\` varchar(255) NOT NULL, \`type\` enum ('current', 'permanent') NULL, \`cityId\` varchar(255) NULL, \`userId\` varchar(255) NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`plans\` (\`id\` varchar(26) NOT NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deletedAt\` datetime(6) NULL, \`name\` varchar(150) NOT NULL, \`description\` text NULL, \`validityDays\` int NOT NULL, \`kmLimit\` decimal(10,2) NOT NULL, \`price\` decimal(10,2) NOT NULL, \`deposit\` decimal(10,2) NOT NULL, \`gstPercentage\` decimal(10,2) NOT NULL DEFAULT '0.00', \`active\` tinyint NOT NULL DEFAULT 1, UNIQUE INDEX \`IDX_253d25dae4c94ee913bc5ec485\` (\`name\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`top_ups\` (\`id\` varchar(26) NOT NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deletedAt\` datetime(6) NULL, \`name\` varchar(150) NOT NULL, \`description\` text NULL, \`kmLimit\` decimal(10,2) NOT NULL, \`price\` decimal(10,2) NOT NULL, \`gstPercentage\` decimal(10,2) NOT NULL DEFAULT '0.00', \`active\` tinyint NOT NULL DEFAULT 1, UNIQUE INDEX \`IDX_941d8639a884218b46ae74c8a8\` (\`name\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`user_top_ups\` (\`id\` varchar(26) NOT NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deletedAt\` datetime(6) NULL, \`userId\` varchar(255) NOT NULL, \`userPlanId\` varchar(255) NOT NULL, \`topUpId\` varchar(255) NOT NULL, \`topUpSnapshot\` json NULL, \`status\` enum ('awaiting', 'applied', 'failed') NOT NULL DEFAULT 'awaiting', \`appliedAt\` datetime NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
        await queryRunner.query(`CREATE TABLE \`user_plans\` (\`id\` varchar(26) NOT NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deletedAt\` datetime(6) NULL, \`userId\` varchar(255) NOT NULL, \`planId\` varchar(255) NOT NULL, \`batteryPercentAtTimeOfSwap\` int NULL, \`planSnapshot\` json NOT NULL, \`status\` enum ('purchased', 'failed', 'pending', 'active', 'expired', 'cancelled') NOT NULL DEFAULT 'pending', \`startsAt\` datetime NULL, \`expiresAt\` datetime NULL, \`remainingKm\` decimal(10,2) NOT NULL, \`totalKm\` decimal(10,2) NOT NULL, \`qrCodeId\` varchar(255) NULL, UNIQUE INDEX \`REL_a08e6a0f0c8f18adc7c7895013\` (\`qrCodeId\`), PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX \`IDX_941d8639a884218b46ae74c8a8\` ON \`top_ups\``);
        await queryRunner.query(`DROP TABLE \`top_ups\``);
        await queryRunner.query(`DROP INDEX \`IDX_253d25dae4c94ee913bc5ec485\` ON \`plans\``);

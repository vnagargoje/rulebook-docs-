                ...
                <ScrollView
                    ...
                    <View className='mx-4 mt-4 overflow-hidden rounded-[28px] bg-[#0B1220] p-5'>
                        ...
                        <Text className='mt-2 text-sm leading-6 text-[#C6D0E0]'>
                            Sign in only when you are ready to book. Till then, explore plans and compare pricing
                            freely.
                        </Text>
        ...
        <SafeAreaView className='flex-1 bg-background'>
            <ScrollView
                ...
                <View className='mx-4 mt-4 overflow-hidden rounded-[28px] bg-[#0B1220] px-5 pb-6 pt-5'>
                    ...
                    <Text className='text-xs font-semibold uppercase tracking-[1.4px] text-[#8EA0BE]'>Profile</Text>
